...
class CloudVendorControllerTest {
    ...
    @BeforeEach
    void setUp() {
        cloudVendorOne = new CloudVendor("1", "Verizon",
                "USA", "xxxxx");
        cloudVendorTwo = new CloudVendor("2", "GoogleCloud",
                "UK", "yyyyy");
    ...
    void createCloudVendorDetails() throws Exception {
        ...
        when(cloudVendorService.createCloudVendorDetails(cloudVendorOne)).thenReturn("Success");
